...
import wireframeTorusUrl from "@assets/generated_images/Wireframe_torus_mathematical_pattern_d812c730.png";
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="mb-8">
        ...
        <div className="relative rounded-xl overflow-hidden mb-6">
          <img 
            src={wireframeTorusUrl} 
            alt="Mathematical wireframe torus pattern" 
